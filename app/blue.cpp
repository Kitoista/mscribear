...
static void blue_init_completed(BLE::InitializationCompleteCallbackContext *params)
{
    ...
    usb.printf("[blue] initializing service\r\n");
    blue_enigma_service = new EnigmaService(ble);
